...
func TestConstraintSurfaceThroughMySQL(t *testing.T) {
	...
	for _, query := range []string{
		...
		"INSERT INTO parent (id, code) VALUES (1, 'P1')",
	...
	for _, query := range []string{
		"INSERT INTO parent (id, code) VALUES (2, 'p1')",
	...
	for _, query := range []string{
		"EXPLAIN FORMAT=JSON INSERT INTO child (id, parent_id) VALUES (7, 1)",
		"EXPLAIN FORMAT=JSON DELETE FROM parent WHERE id = 1",
	} {
