...
func TestEvaluateArithmetic(t *testing.T) {
	cases := map[string]string{
		...
		"9223372036854775807 DIV 2e0":        "4611686018427387903",
		"9223372036854775806 DIV 1e0":        "9223372036854775806",
		"-9223372036854775807 DIV 1e0":       "-9223372036854775807",
		"-9223372036854775807 DIV 2e0":       "-4611686018427387903",
...
func TestEvaluateArithmeticFailsClosed(t *testing.T) {
	for _, expression := range []string{
		...
		"1e19 DIV 1e0",
		"9223372036854775808.0 DIV 1e0",
		"9223372036854776832.0 DIV 1e0",
		"'a' + 1",
		"1 + 'a'",
		"'a' DIV 1",
		"1e308 * 1e308",
...
func TestEvaluateUnsignedArithmeticKeepsUnsignedDomain(t *testing.T) {
	for expression, want := range map[string]uint64{
		...
		"18446744073709551615 DIV 1e0":                  18446744073709551615,
		"18446744073709551615 DIV 2e0":                  9223372036854775807,
		"9223372036854775808 DIV 1e0":                   9223372036854775808,
		"CAST(9223372036854775808 AS UNSIGNED) DIV 1":   9223372036854775808,
		"CAST(9223372036854775808 AS UNSIGNED) DIV 1e0": 9223372036854775808,
